...
const GENRE_SEO = {
  ...
  'kids-plays': {
    ...
    points: [
      [`От детских звёзд до любимой классики:`, `Большие яркие постановки к праздникам вроде Хануки и Суккота, продуманные фестивали и знакомые детские истории, на которых мы все выросли, оживающие на сцене.`],

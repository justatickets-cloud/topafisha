...
${/og:image/.test(head) ? '' : `<meta property="og:image" content="${BRAND.domain}/assets/og-default.png">
...
function siteHeader() {
  ...
  <div class="wrap header-inner">
    ...
    <nav class="top-nav">
      <a href="/" class="nav-home">Все мероприятия</a>
...
function siteFooter() {
  ...
  <div class="wrap footer-timing">
    ...
    <a href="/афиша-сегодня">Афиша на сегодня</a>
    <a href="/афиша-на-выходные">На выходные</a>
    <a href="/афиша-на-неделю">На неделю</a>
    <a href="/афиша-на-месяц">На месяц</a>
    <a href="/афиша-2026">Афиша 2026</a>
    <a href="/афиша-2027">Афиша 2027</a>
  </div>
...
function hubEmpty() {
  return `<div class="hub-empty">
    ...
    <ul class="hub-empty-links">
      ...
      <li><a href="/афиша-на-неделю">Афиша на неделю</a></li>
      <li><a href="/афиша-на-месяц">Афиша на месяц</a></li>
      <li><a href="/афиша-2026">Все мероприятия 2026</a></li>
    </ul>
  </div>`;
}
...
const GENRE_SEO = {
  ...
  'opera': {
    h2: `Вечер классики и вокальной мощи: лучшие оперные спектакли Израиля в одном месте`,
    lead: `Ничто не заменит силу живого человеческого голоса на сцене, продуманные декорации и волнение, которое наполняет зал. Мы собрали для вас большие оперные постановки, вокальные концерты и сольные программы лучших солистов и оркестров Израиля и мира.`,
    points: [
      [`Шедевры и большие постановки:`, `От «Травиаты» и «Сельской чести» до знаменитых арий и праздничных оперных вечеров при свечах.`],
      [`Полное спокойствие:`, `Полностью защищённая оплата, оптимальный выбор мест и электронные билеты, которые приходят прямо вам на почту без лишних усилий.`],
    ],
    cta: `Билеты в лучшие места с самой удачной акустикой разбирают быстро. Листайте вниз, выберите спектакль и займите место прямо сейчас!`,
  },
  'classical': {
    h2: `Опыт звука, эмоций и гармонии: лучшие концерты и классическая музыка Израиля`,
    lead: `Для любителей музыки, которые ищут идеальное сочетание виртуозности и прекрасной акустики. Мы собираем для вас лучшие концерты, сольные программы и оркестры, чтобы вы могли насладиться величайшими произведениями, не тратя усилий на поиск билетов.`,
    points: [
      [`От Баха через Моцарта до Бетховена:`, `Живое исполнение шедевров всех времён: филармонические оркестры, камерные ансамбли, солисты из Израиля и из-за рубежа и волшебные концерты в особой атмосфере.`],
      [`Ноль усилий, полное спокойствие:`, `Быстрая и защищённая покупка, удобный выбор мест и электронные билеты, которые приходят прямо вам на почту.`],
    ],
    cta: `Билеты в места с лучшей акустикой в зале разбирают быстро. Листайте вниз, выберите свой следующий концерт и займите место прямо сейчас!`,
  },
  'kids-plays': {
    h2: `Создаём воспоминания с детьми: лучшие детские спектакли и шоу Израиля в одном месте`,
    lead: `Ищете идеальный семейный выход на ближайшие каникулы или на субботнее утро? Вместо того чтобы ломать голову в поисках, мы собрали для вас всё, что дети (да и вы тоже) действительно любят смотреть, рядом с домом и без лишних усилий.`,
    points: [
      [`От детских героев до вечной классики:`, `Большие постановки к праздникам вроде Хануки и Суккота и книги детства, оживающие на сцене: Золушка, Пиноккио, Алиса в Стране чудес, Тарзан, Робинзон Крузо, Принц и нищий, Сердце и Новое платье короля. А рядом с ними любимые спектакли, такие как «Дом Яэль», и шоу звёзд, например Мики и «Карнавал Юваля».`],
      [`Ноль усилий, спокойствие для родителей:`, `Лёгкая и защищённая покупка, быстрый выбор мест и электронные билеты, которые приходят прямо вам на почту.`],
    ],
    cta: `Билеты на праздничные шоу и популярные спектакли разбирают быстрее всего. Листайте вниз, выберите следующий спектакль и займите отличные места для всей семьи!`,
  },
  'plays': {
    h2: `Магия израильского театра: лучшие спектакли и актёры на одной сцене`,
    lead: `Выйти из рутины, погрузиться в захватывающий сюжет и увидеть больших израильских актёров вблизи. Вместо того чтобы прыгать между разными кассовыми сайтами, мы собрали для вас все самые горячие спектакли театрального мира в одном месте и без лишних усилий.`,
    points: [
      [`От классики до дерзких комедий и драм:`, `Богатый репертуар с лучшими талантами на сценах ведущих театров Израиля: Национальный театр «Габима», Камерный театр, «Бейт Лесин», Театр Орны Порат, «Тмуна» и «Цавта».`],
      [`Ноль усилий, полное спокойствие:`, `Лёгкая и защищённая покупка, выбор лучших мест в зале и электронные билеты, которые приходят прямо вам на почту.`],
    ],
    cta: `Билеты в центральные ряды и на популярные даты разбирают быстро. Листайте вниз, выберите следующий спектакль и займите место прямо сейчас!`,
  },
  'jazz': {
    h2: `Ритм, душа и блюзовые ноты: лучшие джаз и блюз концерты Израиля`,
    lead: `Для любителей свободной импровизации, горячего свинга и пронзительного блюзового крика. Вместо того чтобы ломать голову в поисках идеального лайн-апа, мы собрали для вас всё волшебство, от интимных полумрачных клубов до больших фестивальных сцен, чтобы вы могли дать своей душе точный грув.`,
    points: [
      [`От клубов Нового Орлеана и Чикаго до бульваров Парижа:`, `Богатый репертуар, возвращающий к жизни легенд музыки. От больших трибьютов дивам вроде Эллы Фицджеральд и Нины Симон, через биг-бэнды и свинг 30-х годов, виртуозный цыганский джаз и до корневого чикагского блюза и кубинских ритмов Буэна Висты.`],
      [`Ноль усилий, полное спокойствие:`, `Быстрая и защищённая покупка, точный выбор мест в зале (чтобы не пропустить ни одной ноты контрабаса или соло саксофона) и электронные билеты, которые приходят прямо вам на почту.`],
    ],
    cta: `Билеты на премиум-шоу и лучшие столики в клубах разбирают быстро. Листайте вниз, займите свои места и отправляйтесь в незабываемое музыкальное путешествие!`,
  },
  'musicals': {
    h2: `Магия сцены и большого шоу: главные мюзиклы Израиля`,
    lead: `Бьётся ли ваше сердце в ритме Бродвея или замирает от больших постановок лондонского Вест-Энда, лететь далеко больше не нужно. Мы собрали для вас лучшие мюзиклы и самые яркие музыкальные постановки страны, ведь когда поднимается занавес и оркестр начинает играть, магия происходит здесь и сейчас.`,
    points: [
      [`От мировых шедевров до израильской классики:`, `Захватывающие большие постановки, такие как «Кабаре», «Вестсайдская история», «Дневник» и «Скрипач на крыше», рядом с хитами местного театра, от «Казаблана» и «Хабадников» до трогательных историй жизни Шошаны Дамари и Офры Хазы.`],
      [`Ноль усилий, полное спокойствие:`, `Лёгкая и защищённая покупка, выбор лучших мест в зале, чтобы не пропустить ни одного костюма или танцевального номера, и электронные билеты, которые приходят прямо вам на почту.`],
    ],
    cta: `Билеты в центральные ряды на большие постановки разбирают быстрее всего. Листайте вниз, выберите свой следующий мюзикл и займите место на вечер незабываемого шоу!`,
  },
};
// Пока включаем только те жанры, что уже утверждены.
const GENRE_SEO_ENABLED = new Set(['standup', 'ballet-dance', 'concerts', 'opera', 'classical', 'kids-plays', 'plays', 'jazz', 'musicals']);
...
<p>Полный список всех мероприятий выходных смотрите на <a href="/афиша-на-выходные">странице афиши на выходные</a>.</p>`,
  };
}
...
function mustSee2027Article(shows) {
  ...
  const list = (arr) => arr.length
    ...
    : `<p>Полный список постоянно обновляется. Перейдите на <a href="/афиша-2027">афишу 2027</a>, чтобы увидеть все мероприятия этой категории.</p>`;
...
<p>Полный обзор читайте в статьях <a href="/magazine/${encodeURI('лучшие-концерты-и-события-2027')}/">Лучшие концерты 2027</a> и <a href="/magazine/${encodeURI('фестивали-и-главные-события-2027')}/">Гид по фестивалям</a>, или переходите прямо к <a href="/афиша-2027"><strong>афише 2027</strong></a>.</p>
...
<article class="hub landing-page">
  <div class="wrap">
    ...
    <p class="landing-related">Смотрите также: <a href="/">полную афишу</a> · <a href="/афиша-2027">афишу 2027</a> · <a href="/magazine/">журнал</a> · <a href="/magazine/${encodeURI('частые-вопросы-о-покупке-билетов')}/">частые вопросы о билетах</a></p>
  </div>
</article>`;
    const html = page({
...
.skip-link{position:absolute;top:-80px;left:12px;z-index:1100;background:var(--plum);color:#fff;padding:10px 18px;border-radius:0 0 12px 12px;font-weight:700;transition:top .15s}
.skip-link:focus{top:0;outline:3px solid var(--gold);outline-offset:2px}
#content{outline:none}
.top-nav a{white-space:nowrap}
.brand{flex-shrink:0}
.top-nav{min-width:0}
@media(max-width:480px){.top-nav .nav-home{display:none}}
@media(max-width:560px){
  .top-nav{gap:12px}
